/**
 * Wrapper que adapta MeusDadosScreen como sub-tela navegada pelo Config.
 * Adiciona botao Voltar no topo sem mexer no layout interno da tela original.
 */
...
export function MeusDadosWrap({ onVoltar }: { onVoltar: () => void }) {
